...
const EditServiceOrder = () => {
    ...
    const loadData = async () => {
      try {
        ...
        if (found) {
          ...
          setListMaintenanceJobs(found.itemMaintenances || []);
          setMaterialsList(found.itemMaterials || []);
          ...
          setListMaintenanceJobs(data.itemMaintenances || []);
          setMaterialsList(data.itemMaterials || []);
  ...
  const handleAddMaintenanceJob = () => {
    ...
    setListMaintenanceJobs([...listMaintenanceJobs, newJob]);
  };

  const handleRemoveMaintenanceJob = (id) => {
    setListMaintenanceJobs(
      listMaintenanceJobs.filter((item) => item.id !== id),
    );
  };
  ...
  const calculateTotalMaterials = () => {
    return materialsList.reduce((total, item) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      for (const item of listMaintenanceJobs) {
      ...
      // 3. Atualizar materiais (materialsList)
                      ...
                      <div className="form-grid g3 form-grid-servico">
                        <div className="field col-2">
                          ...
                          <select
                            className="select"
                            value={
                              element.maintenance_id !== null &&
                              element.maintenance_id !== undefined
          ...
          {/* <div className="status-card">
            ...
            <div className="status-card-body edit-order-status-card-body">
              ...
              <div className="info-row">
                ...
                <span className="info-row-value">{materialsList.length}</span>
              </div>
              <div className="info-row">
